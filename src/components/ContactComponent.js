...
class Contact extends Component {
    ...
    handleInputChange(event) {
        ...
        const value = target.type === 'checkbox' ? target.chechked :target.value;
    ...
    return(
        <div className="container">
            ...
            <div className="row">
                    ...
                    <BreadcrumbItem><Link active to='/contactus'>Contact Us</Link></BreadcrumbItem>
                    </Breadcrumb>
                ...
                <div className="col-12 col-md-9">
                    ...
                    <FormGroup row>
                        ...
                        <Col md={{size: 3, offset:1}}>
                            <Input type="select" name="contactType" value={this.state.CantactType} onChange={this.handleInputChange}>
                                <option>Tel.</option>
                                <option>Email</option>
                            </Input>
                        </Col>
